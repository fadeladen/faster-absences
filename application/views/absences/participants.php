			...
			columnDefs: [{
					...
					render: function (data, _, row) {
						return `<div style="width: 100px !important;" class="d-flex flex-column">
												...
												<p style="cursor: pointer;" class="link-primary d-flex align-items-center change-consumption-receipt mt-1">
				...
				},
				{
					...
					render: function (data, _, row) {
						return `<div style="width: 100px !important;" class="d-flex flex-column">
                                        ...
                                        <div class="transfer-file-upload d-none">
                                            <input type="file" data-id="${row[17]}" class="form-control transfer-receipt-file">
